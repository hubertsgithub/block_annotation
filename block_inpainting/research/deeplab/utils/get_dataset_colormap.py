...
# Dataset names.
_ADE20K = 'ade20k'
_MSCOCO_PANOPTIC = 'mscoco_panoptic'
...
def create_mscoco_panoptic_label_colormap():
    """Creates a label colormap used in ADE20K segmentation benchmark.

    Returns:
      A colormap for visualizing segmentation results.
    """
    colormap = create_ade20k_label_colormap()[:134]
    colormap[103] = [230, 230, 0]    # sand
    colormap[104] = [0, 128, 255]  # sea
    colormap[117] = [0, 179, 0]    # tree-merged
    colormap[120] = [102, 255, 255]  # sky-other-merged
    colormap[125] = [255, 153, 0]  # mountain-merged
    colormap[126] = [153, 255, 51]  # grass-merged
    colormap[127] = [153, 102, 0]  # dirt-merged
    return colormap
...
def create_label_colormap(dataset=_PASCAL):
    ...
    elif dataset == _MSCOCO_PANOPTIC:
        return create_mscoco_panoptic_label_colormap()
    elif dataset == _MINC:
