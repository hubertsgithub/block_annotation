...
tf.app.flags.DEFINE_enum('boundary_hint_format', 'png', ['png'],
                         'Boundary hint format.')

tf.app.flags.DEFINE_enum('nonboundary_hint_format', 'png', ['png'],
                         'Boundary hint format.')

tf.app.flags.DEFINE_enum('class_hint_format', 'png', ['png'],
                         'Class hint format.')

tf.app.flags.DEFINE_enum('boundary_dmap_format', 'png', ['png'],
                         'Boundary normalized distance map format.')
